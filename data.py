...
from imagenet_ao_ood_and_model_loader import load_imagenet_ao_ood_data
# img_shape = (32, 32, 3)
...
def out_of_dist(dataset_name, debug=False):
    ...
    #        })
        ...
        imageney_ao_ood = load_imagenet_ao_ood_data() 
        datasets.update({
            "imagenet_a" : imageney_ao_ood["imagenet_a_loader"],
            "imagenet_o" : imageney_ao_ood["imagenet_o_loader"]
